...
public class ComputedGradientColor implements GradientColor {
  ...
  public ComputedGradientColor(float[] colorPositions, int[] colorStops, @Nullable float[] opacityPositions, @Nullable float[] opacityStops) {
  ...
  public void lerp(GradientColor c1, GradientColor c2, float progress) {
    if(c1 instanceof ComputedGradientColor && c2 instanceof ComputedGradientColor) {
      ComputedGradientColor gc1 = (ComputedGradientColor) c1;
      ComputedGradientColor gc2 = (ComputedGradientColor) c2;
      ...
      throw new IllegalArgumentException("Nawp");
    }
  }
}
